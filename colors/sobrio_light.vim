...
call s:HL('typescriptDestructureVariable', 'NONE', 'NONE', 'NONE', 'NONE', s:var)
...
call s:HL('typescriptOperator', 'NONE', 'NONE', s:i, 'NONE', s:word)
call s:HL('typescriptParens', 'NONE', 'NONE', 'NONE', 'NONE', s:other)
call s:HL('typescriptTry', 'NONE', 'NONE', 'NONE', 'NONE', s:word)
